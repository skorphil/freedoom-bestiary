...
const contributorsPath = '/Users/philipp/Documents/GitHub/freedoom-bestiary/packages/database/data/contributors.jsonc';
const contributionsPath = '/Users/philipp/Documents/GitHub/freedoom-bestiary/packages/database/data/contributions.jsonc';
...
const updatedContributions = contributionsRaw.replace(/"contributorId":\s*"([^"]+)"/g, (match, name) => {
