...
function CharacterSnippet({secondaryText, title, spritesheetId}: CharacterSnippetProps) {
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const navigate = useNavigate()
  useAnimation({canvasRef, uuid:spritesheetId, initialAnimation: "chasing", initialAngle: 2 })

  return (
    <div role="link" onClick={() => navigate(`/${spritesheetId}`)} className={styles.snippetContainer}>
